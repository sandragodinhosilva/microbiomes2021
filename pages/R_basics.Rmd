...
```{r}
cog_table = read.csv("https://raw.githubusercontent.com/sandragodinhosilva/sandragodinhosilva/microbiomes2021/tree/main/pages/data/cog_table.csv")
...
```{r}
write.csv(cars, file='cog_table.csv')
```
