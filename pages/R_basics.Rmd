...
pane (more about the RStudio layout in a moment), you should see an RStudio
 project file, **Tutorial_r.Rproj**. All RStudio projects end with the
...
window that opens, name your file **"Tutorial_r_basics"**. The new script
**Tutorial_r_basics.R** should appear under "files" in the output pane. By
convention, R scripts end with the file extension **.R**.

## Overview and customization of the RStudio layout

There are the major windows (or panes) of the RStudio
environment:
...
Now we can get to work using some commands. We will write, execute, and save the commands we
learn in our **Tutorial_r_basics.R** script that is loaded in the Source pane.
