...
```{r}
cars = read.table('https://raw.githubusercontent.com/sandragodinhosilva/microbiome2021_materials/main/data/mtcars.csv', header=T, sep = ',') # Read a comma separated values file
head(cars)

cars = read.csv('https://raw.githubusercontent.com/sandragodinhosilva/microbiome2021_materials/main/data/mtcars.csv')

cars = read.delim('https://raw.githubusercontent.com/sandragodinhosilva/microbiome2021_materials/main/data/mtcars.csv', sep=',')
...
Sources: 
- [Data Analysis and Visualization in R for Ecologists](https://datacarpentry.org/R-ecology-lesson/00-before-we-start.html)


# [Home](https://sandragodinhosilva.github.io/microbiomes2021_course)
